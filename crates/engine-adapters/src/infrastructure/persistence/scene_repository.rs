...
impl From<wrldbldr_domain::TimeOfDay> for TimeOfDayStored {
    fn from(value: wrldbldr_domain::TimeOfDay) -> Self {
        use wrldbldr_domain::TimeOfDay as T;
        match value {
...
impl From<TimeOfDayStored> for wrldbldr_domain::TimeOfDay {
