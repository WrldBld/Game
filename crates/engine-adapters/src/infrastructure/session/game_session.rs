...
use wrldbldr_engine_app::application::dto::WorldSnapshot;
...
pub struct GameSession {
    ...
    pub player_characters: HashMap<String, wrldbldr_domain::entities::PlayerCharacter>,
...
impl GameSession {
    ...
    pub fn add_player_character(
        &mut self,
        pc: wrldbldr_domain::entities::PlayerCharacter,
    ) -> Result<(), String> {
    ...
    pub fn get_player_character(
        &self,
        user_id: &str,
    ) -> Option<&wrldbldr_domain::entities::PlayerCharacter> {
    ...
    pub fn get_all_pcs(&self) -> Vec<&wrldbldr_domain::entities::PlayerCharacter> {
