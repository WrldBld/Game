...
pub fn load_thornhaven() -> TestWorld {
    ...
    TestWorld {
        ...
        home_regions: schedules_file.home_regions,
        works_at: schedules_file.works_at,
        works_at_region: schedules_file.works_at_region,
        frequents: schedules_file.frequents,
        frequents_region: schedules_file.frequents_region,
        avoids: schedules_file.avoids,
        avoids_region: schedules_file.avoids_region,
