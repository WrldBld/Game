...
// =============================================================================
// From Implementations for Protocol -> App DTO Conversions
// =============================================================================
//
// These implementations allow player-ui to use `.into()` to convert protocol
// types to app DTOs. Since player-app defines the target types, the orphan
// rules allow these impls here.
