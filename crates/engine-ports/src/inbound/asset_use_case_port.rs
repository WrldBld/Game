//! Asset use case port - Inbound interface for asset gallery operations
//!
//! This port is called by HTTP handlers to manage assets and batches.
...
/// Port for asset use case operations
///
/// Called by: HTTP handlers in asset_routes.rs
/// Implemented by: AssetService in engine-app
#[cfg_attr(any(test, feature = "testing"), mockall::automock)]
#[async_trait]
pub trait AssetUseCasePort: Send + Sync {
