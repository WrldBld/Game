...
pub fn PCCreationView(props: PCCreationProps) -> Element {
    ...
    let mut available_locations: Signal<Vec<wrldbldr_player_app::application::services::LocationSummary>> = use_signal(Vec::new);
...
struct StartingLocationStepProps {
    locations: Vec<wrldbldr_player_app::application::services::LocationSummary>,
...
struct LocationCardProps {
    location: wrldbldr_player_app::application::services::LocationSummary,
    is_selected: bool,
